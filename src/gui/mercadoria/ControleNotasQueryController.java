...
public class ControleNotasQueryController implements Initializable {
	...
	@FXML
	private CheckBox chbNumeroNota = new CheckBox();
	...
	public void onBtConsultaAction(ActionEvent event) {
		try {
			...
			loadView("/gui/mercadoria/ControleNotasList.fxml", (ControleNotasListController controller) -> {
	...
	private void getForm() {
		...
		boolean numeroNota = chbNumeroNota.isSelected();
		...
		if (todos == true) {
				...
				& (txtNumeroNota.getText() == null || txtNumeroNota.getText().trim().equals(""))
		...
		if (todos == true) {
			tipo = 1;
			consulta = "todos";
		} else if (numeroNota == true) {
			tipo = 2;
			consulta = txtNumeroNota.getText();
		...
		if ((todos == true && numeroNota == true) || (numeroNota == true && motorista == true)
				|| (numeroNota == true && data == true) || (motorista == true && data == true)
	...
	private void initializeNodes() {
		...
		Constraints.setTextFieldInteger(txtNumeroNota);
		Constraints.setTextFieldMaxLength(txtNumeroNota, 9);
