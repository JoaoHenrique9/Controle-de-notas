...
public class TransferenciaQueryController implements Initializable {
	...
	@FXML
	private CheckBox chbNotaFiscal = new CheckBox();
	...
	public void SetTransferencia(String consulta) {
	...
	public void onBtConsultaAction(ActionEvent event) {
		try {
			...
			loadView("/gui/transferencia/TransferenciaList.fxml", (TransferenciaListController controller) -> {
	...
	private void getForm() {
		...
		boolean notaFiscal = chbNotaFiscal.isSelected();
		...
		if (todos == true) {
				...
				& (txtNotaFiscal.getText() == null || txtNotaFiscal.getText().trim().equals(""))
		...
		if (todos == true) {
			tipo = 1;
			consulta = "todos";
		} else if (notaFiscal == true) {
			tipo = 2;
			consulta = txtNotaFiscal.getText();
		...
		if ((todos == true && notaFiscal == true) || (notaFiscal == true && motorista == true)
				|| (notaFiscal == true && data == true) || (motorista == true && data == true)
	...
	private void initializeNodes() {
		...
		Constraints.setTextFieldInteger(txtNotaFiscal);
		Constraints.setTextFieldMaxLength(txtNotaFiscal, 9);
