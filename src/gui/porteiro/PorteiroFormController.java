...
public class PorteiroFormController implements Initializable {
	
	// Atributos	
	private Porteiro entity;
	...
	public void setPorteiro(Porteiro entity) {
		this.entity = entity;
	}
	...
	// Inclusão no banco.
	private void saveDatePorteiro() {
		Porteiro obj = new Porteiro();
		entity = getFormPorteiro();
		obj = service.findPorteiro(entity);
		if (obj == null) {
	...
	private Porteiro getFormPorteiro() {
		...
		porteiro.setId(Utils.tryParseToInt(txtId.getText()));
	...
	public void updateFormData() {
		...
		txtPorteiro.setText(entity.getNome());
